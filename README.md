...
Some examples depicting the use of developed functions can be found in "attract_exp/using_scripts_examples". For bunding box creation you can check the instructions and functions provided in "attract_exp/bbox_utilities".
