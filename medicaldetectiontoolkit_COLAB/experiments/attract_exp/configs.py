...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.root_dir = '/content/drive/My Drive/Projetos/medicaldetectiontoolkit_COLAB'
        ...
        self.generate_bboxes = True

        # patch_size to be used for training. pre_crop_size is the patch_size before data augmentation.
        self.pre_crop_size_2D = [300, 300]
        self.patch_size_2D = [288, 288]
        self.pre_crop_size_3D = [128, 128, 32]
        self.patch_size_3D = [128, 128, 32]
